...
<span id="brig">
![Brig Portrait](images/portraits/brig.png)
</span>

# Brig

<span class="champIntro">Brig is in the Sirens of the Realms affiliation and normally benefits from the following stat nodes:</span>
...
<span class="champIntro">Brig is a melee champion.</span>
        ...
        <span class="buffboxRow" id="buffboxNone">
            <span class="buffboxRowCol">
                <span class="buffboxRowNone">
                    Brig does not gain the benefit of extra stat nodes from any stat increasing formation abilities.
                </span>
            </span>
        </span>
...
{:/nomarkdown}
{::nomarkdown}
    <a href="https://ic.byteglow.com/modron/wobeCc5uTsahDCYO7SNFh" target="_blank" data-core-id="1" data-buffs="Feats to Spare" hidden>
{:/nomarkdown}
    <span class="modronRow">
        <span class="modronIconFull">
...
{:/nomarkdown}
{::nomarkdown}
    <a href="https://ic.byteglow.com/modron/prsIbEnw55x08HwTsT4A3" target="_blank" data-core-id="2" data-buffs="">
{:/nomarkdown}
    <span class="modronRow">
        <span class="modronIconFull">
            ![Strong Core](images/core_2_strong.png)Strong
...
{:/nomarkdown}
{::nomarkdown}
    <a href="https://ic.byteglow.com/modron/lxl77lg_2zUFrv6SLU6-E" target="_blank" data-core-id="1" data-buffs="Witch's Switch" hidden>
{:/nomarkdown}
    <span class="modronRow">
        <span class="modronIconFull">
            ![Modest Core](images/core_1_modest.png)Modest
...
{:/nomarkdown}
{::nomarkdown}
    <a href="https://ic.byteglow.com/modron/dqiI3WxKx8gYnqFFrmddG" target="_blank" data-core-id="1" data-buffs="">
{:/nomarkdown}
    <span class="modronRow">
        <span class="modronIconFull">
            ![Modest Core](images/core_1_modest.png)Modest
...
{:/nomarkdown}
{::nomarkdown}
    <a href="https://ic.byteglow.com/modron/1GTgb0TcV1rE5D0W0Uoyj" target="_blank" data-core-id="4" data-buffs="Witch's Switch" hidden>
{:/nomarkdown}
    <span class="modronRow">
        <span class="modronIconFull">
            ![Magic Core](images/core_4_magic.png)Magic (Non-Magic Variant)
...
The Dexterous core is far enough ahead of the Magic (Non-Magic Variant) core that it's the best one to use for Brig. I do not recommend even trying the Magic core because it doesn't have any health nodes.

Note that the damage of the Dexterous core varies depending on the number of 15+ Dexterity champions in the formation. The damage numbers on the layout above account for just 1 (Brig only). For a specific breakdown of how the core fares with more 15+ Dexterity champions - check the table below.
