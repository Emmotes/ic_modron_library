...
The Magic core is so far ahead of the Modest core that it's really the only choice for Donaar. Though it is worth noting that it doesn't have any health nodes.
