...
<span id="beadle">
![Beadle Portrait](images/portraits/beadle.png)
</span>

# Beadle

<span class="champIntro">Beadle is unaffiliated, True Neutral and normally benefits from the following stat nodes:</span>
        ...
        <span class="buffboxRow" id="buffboxNone">
            <span class="buffboxRowCol">
                <span class="buffboxRowNone">
                    Beadle does not gain the benefit of extra stat nodes from any stat increasing formation abilities.
                </span>
            </span>
        </span>
...
{::nomarkdown}
    <a href="https://ic.byteglow.com/modron/JT8G1GuvxO8RztguPGG6A" target="_blank" data-core-id="4" data-buffs="Circle Magic,Witch's Switch" hidden>
{:/nomarkdown}
...
{:/nomarkdown}
{::nomarkdown}
    <a href="https://ic.byteglow.com/modron/JT8G1GuvxO8RztguPGG6A" target="_blank" data-core-id="4" data-buffs="Feats to Spare,Witch's Switch" hidden>
{:/nomarkdown}
    <span class="modronRow">
        <span class="modronIconFull">
            ![Magic Core](images/core_4_magic.png)Magic
...
{:/nomarkdown}
{::nomarkdown}
    <a href="https://ic.byteglow.com/modron/wH3soyJdJDuixeIFxGPNw" target="_blank" data-core-id="4" data-buffs="">
{:/nomarkdown}
    <span class="modronRow">
        <span class="modronIconFull">
            ![Magic Core](images/core_4_magic.png)Magic
...
{:/nomarkdown}
{::nomarkdown}
    <a href="https://ic.byteglow.com/modron/ME5yZd7N0M22Zo9pT8C8n" target="_blank" data-core-id="2" data-buffs="Circle Magic" hidden>
{:/nomarkdown}
    <span class="modronRow">
        <span class="modronIconFull">
...
{:/nomarkdown}
{::nomarkdown}
    <a href="https://ic.byteglow.com/modron/QNbT8eQbHm8BiFYoERFss" target="_blank" data-core-id="2" data-buffs="">
{:/nomarkdown}
    <span class="modronRow">
        <span class="modronIconFull">
            ![Strong Core](images/core_2_strong.png)Strong
        ...
        <span class="modronLink">
            ic.byteglow.com/modron/QNbT8eQbHm8BiFYoERFss
        </span>
        <span class="modronDamage">
            1.68e41%
        </span>
...
{:/nomarkdown}
{::nomarkdown}
    <a href="https://ic.byteglow.com/modron/Xzh26vGh4j3A2MDbQS6na" target="_blank" data-core-id="2" data-buffs="Circle Magic,Witch's Switch" hidden>
{:/nomarkdown}
    <span class="modronRow">
        <span class="modronIconFull">
            ![Strong Core](images/core_2_strong.png)Strong
...
{:/nomarkdown}
{::nomarkdown}
    <a href="https://ic.byteglow.com/modron/Xzh26vGh4j3A2MDbQS6na" target="_blank" data-core-id="2" data-buffs="Feats to Spare,Witch's Switch" hidden>
{:/nomarkdown}
    <span class="modronRow">
        <span class="modronIconFull">
            ![Strong Core](images/core_2_strong.png)Strong
...
{:/nomarkdown}
{::nomarkdown}
    <a href="https://ic.byteglow.com/modron/sGv2PkfUhcXsZAEQEDdvy" target="_blank" data-core-id="1" data-buffs="Circle Magic" hidden>
{:/nomarkdown}
    <span class="modronRow">
        <span class="modronIconFull">
...
{:/nomarkdown}
{::nomarkdown}
    <a href="https://ic.byteglow.com/modron/HH_3nQBXc5mRXZI8HNNLb" target="_blank" data-core-id="1" data-buffs="Circle Magic,Witch's Switch" hidden>
{:/nomarkdown}
    <span class="modronRow">
        <span class="modronIconFull">
            ![Modest Core](images/core_1_modest.png)Modest
...
{:/nomarkdown}
{::nomarkdown}
    <a href="https://ic.byteglow.com/modron/HH_3nQBXc5mRXZI8HNNLb" target="_blank" data-core-id="1" data-buffs="Feats to Spare,Witch's Switch" hidden>
{:/nomarkdown}
    <span class="modronRow">
        <span class="modronIconFull">
            ![Modest Core](images/core_1_modest.png)Modest
...
{:/nomarkdown}
{::nomarkdown}
    <a href="https://ic.byteglow.com/modron/gtKDCrDI7qJVatgWpQfPG" target="_blank" data-core-id="2" data-buffs="Witch's Switch" hidden>
{:/nomarkdown}
    <span class="modronRow">
        <span class="modronIconFull">
            ![Strong Core](images/core_2_strong.png)Strong
        ...
        <span class="modronLink">
            ic.byteglow.com/modron/gtKDCrDI7qJVatgWpQfPG
        </span>
        <span class="modronDamageBuffed">
            1.16e39%
        </span>
...
{:/nomarkdown}
{::nomarkdown}
    <a href="https://ic.byteglow.com/modron/NlZjPJ4DECNoQSfpQKnyQ" target="_blank" data-core-id="1" data-buffs="Witch's Switch" hidden>
{:/nomarkdown}
    <span class="modronRow">
        <span class="modronIconFull">
            ![Modest Core](images/core_1_modest.png)Modest
