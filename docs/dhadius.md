...
<span class="champIntro">Dhadius is unaffiliated, Chaotic Neutral and normally benefits from the following stat nodes:</span>
...
{:/nomarkdown}
{::nomarkdown}
    <a href="https://ic.byteglow.com/modron/rp3P3F7nafN1YztHnFCEz" target="_blank" data-core-id="2" data-buffs="Feats to Spare,Circle Magic,Witch's Switch" hidden>
{:/nomarkdown}
    <span class="modronRow">
        <span class="modronIconFull">
            ![Strong Core](images/core_2_strong.png)Strong (Non-Melee Variant)
...
{:/nomarkdown}
{::nomarkdown}
    <a href="https://ic.byteglow.com/modron/kRfXK-yTMZCyAetYYUfeD" target="_blank" data-core-id="1" data-buffs="Feats to Spare,Circle Magic,Witch's Switch" hidden>
{:/nomarkdown}
    <span class="modronRow">
        <span class="modronIconFull">
            ![Modest Core](images/core_1_modest.png)Modest
...
{:/nomarkdown}
{::nomarkdown}
    <a href="https://ic.byteglow.com/modron/EH9B2Knq8YGwLvmVx1l4o" target="_blank" data-core-id="2" data-buffs="Witch's Switch" hidden>
{:/nomarkdown}
    <span class="modronRow">
        <span class="modronIconFull">
            ![Strong Core](images/core_2_strong.png)Strong (Non-Melee Variant)
        ...
        <span class="modronLink">
            ic.byteglow.com/modron/EH9B2Knq8YGwLvmVx1l4o
        </span>
        <span class="modronDamageBuffed">
            6.52e34%
        </span>
...
{:/nomarkdown}
{::nomarkdown}
    <a href="https://ic.byteglow.com/modron/NPhidPgZUFf02Wf8QwwDl" target="_blank" data-core-id="1" data-buffs="Witch's Switch" hidden>
{:/nomarkdown}
    <span class="modronRow">
        <span class="modronIconFull">
            ![Modest Core](images/core_1_modest.png)Modest
        ...
        <span class="modronLink">
            ic.byteglow.com/modron/NPhidPgZUFf02Wf8QwwDl
        </span>
        <span class="modronDamageBuffed">
            1.51e34%
        </span>
