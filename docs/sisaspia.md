...
<span id="sisaspia">
![Sisaspia Portrait](images/portraits/sisaspia.png)
</span>

# Sisaspia

<span class="champIntro">Sisaspia is unaffiliated and normally benefits from the following stat nodes:</span>
...
<span class="champIntro">Sisaspia is a magic champion.</span>
        ...
        <span class="buffboxRow" id="buffboxNone">
            <span class="buffboxRowCol">
                <span class="buffboxRowNone">
                    Sisaspia does not gain the benefit of extra stat nodes from any stat increasing formation abilities.
                </span>
            </span>
        </span>
...
Note that the damage of the Unaffiliated and Dexterous cores vary depending on the number of unaffiliated or 15+ Dexterity champions (respectively) in the formation. The damage numbers on the layout above account for just 1 (Sisaspia only). For a specific breakdown of how the cores fare with more unaffiliated or 15+ Dexterity champions - check the tables below.
