...
<span class="champIntro">Shadowheart is in the Absolute Adversaries affiliation, Lawful Neutral and normally benefits from the following stat nodes:</span>
...
The Lawful core is far enough ahead of the Magic core that it's the best one to use for Shadowheart. I do not recommend even trying the Magic core because it doesn't have any health nodes.
