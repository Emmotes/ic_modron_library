...
<span id="laurana">
![Laurana Portrait](images/portraits/laurana.png)
</span>

# Laurana

<span class="champIntro">Laurana is in the Heroes of the Lance affiliation, Neutral Good and normally benefits from the following stat nodes:</span>
        ...
        <span class="buffboxRow" id="buffboxNone">
            <span class="buffboxRowCol">
                <span class="buffboxRowNone">
                    Laurana does not gain the benefit of extra stat nodes from any stat increasing formation abilities.
                </span>
            </span>
        </span>
...
The Dexterous core is so far ahead of the other cores that it's really the only choice for Laurana.
