...
<span class="champIntro">Strix is in the Acquisitions Incorporated and Waffle Crew affiliations and normally benefits from the following stat nodes:</span>
...
<span class="champIntro">Strix is a magic champion.</span>
        ...
        <span class="buffboxRow" id="buffboxNone">
            <span class="buffboxRowCol">
                <span class="buffboxRowNone">
                    Strix does not gain the benefit of extra stat nodes from any stat increasing formation abilities.
                </span>
            </span>
        </span>
...
Note that the damage of the Dexterous core varies depending on the number of 15+ Dexterity champions in the formation. The damage numbers on the layout above account for just 1 (Strix only). For a specific breakdown of how the core fares with more 15+ Dexterity champions - check the table below.
