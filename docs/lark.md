...
<span id="lark">
![Lark Portrait](images/portraits/lark.png)
</span>

# Lark

<span class="champIntro">Lark is in the The Fallbacks affiliation, Chaotic Neutral and normally benefits from the following stat nodes:</span>
...
<span class="champIntro">Lark is a magic champion.</span>
        ...
        <span class="buffboxRow" id="buffboxNone">
            <span class="buffboxRowCol">
                <span class="buffboxRowNone">
                    Lark does not gain the benefit of extra stat nodes from any stat increasing formation abilities.
                </span>
            </span>
        </span>
