...
<span id="kyre">
![Kyre Portrait](images/portraits/kyre.png)
</span>

# Kyre

<span class="champIntro">Kyre is unaffiliated, Lawful Good and normally benefits from the following stat nodes:</span>
...
<span class="champIntro">Kyre is a magic champion.</span>
        ...
        <span class="buffboxRow" id="buffboxNone">
            <span class="buffboxRowCol">
                <span class="buffboxRowNone">
                    Kyre does not gain the benefit of extra stat nodes from any stat increasing formation abilities.
                </span>
            </span>
        </span>
