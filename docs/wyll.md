...
<span id="wyll">
![Wyll Portrait](images/portraits/wyll.png)
</span>

# Wyll

<span class="champIntro">Wyll is in the Absolute Adversaries affiliation and normally benefits from the following stat nodes:</span>
...
<span class="champIntro">Wyll is a melee and magic champion.</span>
        ...
        <span class="buffboxRow" id="buffboxNone">
            <span class="buffboxRowCol">
                <span class="buffboxRowNone">
                    Wyll does not gain the benefit of extra stat nodes from any stat increasing formation abilities.
                </span>
            </span>
        </span>
...
The Magic core is so far ahead of the other cores that it's really the only choice for Wyll. Though it is worth noting that it doesn't have any health nodes.
...
Note that the damage of the Dexterous core varies depending on the number of 15+ Dexterity champions in the formation. The damage numbers on the layout above account for just 1 (Wyll only). For a specific breakdown of how the core fares with more 15+ Dexterity champions - check the table below.
