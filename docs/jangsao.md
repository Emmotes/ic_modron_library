...
<span id="jangsao">
![Jang Sao Portrait](images/portraits/jangsao.png)
</span>

# Jang Sao

<span class="champIntro">Jang Sao is unaffiliated, True Neutral and normally benefits from the following stat nodes:</span>
...
<span class="champIntro">Jang Sao is a ranged champion.</span>
        ...
        <span class="buffboxRow" id="buffboxNone">
            <span class="buffboxRowCol">
                <span class="buffboxRowNone">
                    Jang Sao does not gain the benefit of extra stat nodes from any stat increasing formation abilities.
                </span>
            </span>
        </span>
...
{:/nomarkdown}
{::nomarkdown}
    <a href="https://ic.byteglow.com/modron/Ji-4uNBtTC7mLA3UCQyfB" target="_blank" data-core-id="1" data-buffs="Feats to Spare,Circle Magic" hidden>
{:/nomarkdown}
    <span class="modronRow">
        <span class="modronIconFull">
