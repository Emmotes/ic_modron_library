...
<span id="windfall">
![Windfall Portrait](images/portraits/windfall.png)
</span>

# Windfall

<span class="champIntro">Windfall is unaffiliated, Chaotic Evil and normally benefits from the following stat nodes:</span>
        ...
        <span class="buffboxRow" id="buffboxNone">
            <span class="buffboxRowCol">
                <span class="buffboxRowNone">
                    Windfall does not gain the benefit of extra stat nodes from any stat increasing formation abilities.
                </span>
            </span>
        </span>
