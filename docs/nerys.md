...
<span class="champIntro">Nerys is in the Heroes of Baldur's Gate affiliation, Lawful Good and normally benefits from the following stat nodes:</span>
...
The Lawful core is far enough ahead of the other cores that it's the best one to use for Nerys. That said - you could potentially use one of the other cores if the pipes you have favours one of them.
