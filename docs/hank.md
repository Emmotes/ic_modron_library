...
<span class="champIntro">Hank is in the Saturday Morning Squad affiliation, Lawful Good and normally benefits from the following stat nodes:</span>
...
The Dexterous and Lawful cores are so far ahead of the other cores that they are really the only choices for Hank. Choose whichever you have the more favourable pipes for.
