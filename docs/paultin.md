...
<span id="paultin">
![Paultin Portrait](images/portraits/paultin.png)
</span>

# Paultin

<span class="champIntro">Paultin is in the Waffle Crew affiliation, Chaotic Neutral and normally benefits from the following stat nodes:</span>
        ...
        <span class="buffboxRow" id="buffboxNone">
            <span class="buffboxRowCol">
                <span class="buffboxRowNone">
                    Paultin does not gain the benefit of extra stat nodes from any stat increasing formation abilities.
                </span>
            </span>
        </span>
