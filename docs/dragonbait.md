...
<span class="champIntro">Dragonbait is unaffiliated, Lawful Good and normally benefits from the following stat nodes:</span>
...
The Unaffiliated and Lawful cores are far enough ahead of the other cores that they are the best ones to use for Dragonbait. That said - you could potentially use one of the other cores if the pipes you have favours one of them.
