...
<span id="wren">
![Wren Portrait](images/portraits/wren.png)
</span>

# Wren

<span class="champIntro">Wren is unaffiliated, Neutral Good and normally benefits from the following stat nodes:</span>
        ...
        <span class="buffboxRow" id="buffboxNone">
            <span class="buffboxRowCol">
                <span class="buffboxRowNone">
                    Wren does not gain the benefit of extra stat nodes from any stat increasing formation abilities.
                </span>
            </span>
        </span>
