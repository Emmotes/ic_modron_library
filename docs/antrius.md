...
<span id="antrius">
![Antrius Portrait](images/portraits/antrius.png)
</span>

# Antrius

<span class="champIntro">Antrius is in the Awful Ones affiliation and normally benefits from the following stat nodes:</span>
...
<span class="champIntro">Antrius is a magic champion.</span>
        ...
        <span class="buffboxRow" id="buffboxNone">
            <span class="buffboxRowCol">
                <span class="buffboxRowNone">
                    Antrius does not gain the benefit of extra stat nodes from any stat increasing formation abilities.
                </span>
            </span>
        </span>
...
{::nomarkdown}
    <a href="https://ic.byteglow.com/modron/1QAVPgKXTPpv6QyZmNM3l" target="_blank" data-core-id="4" data-buffs="Feats to Spare,Best And The Brightest" hidden>
{:/nomarkdown}
...
{:/nomarkdown}
{::nomarkdown}
    <a href="https://ic.byteglow.com/modron/uPENWunG92vAP47zSu7uZ" target="_blank" data-core-id="1" data-buffs="Feats to Spare,Best And The Brightest" hidden>
{:/nomarkdown}
    <span class="modronRow">
        <span class="modronIconFull">
...
{:/nomarkdown}
{::nomarkdown}
    <a href="https://ic.byteglow.com/modron/t5N5een-w8gjhTS37X0Kf" target="_blank" data-core-id="2" data-buffs="Feats to Spare,Best And The Brightest" hidden>
{:/nomarkdown}
    <span class="modronRow">
        <span class="modronIconFull">
...
The Magic core is so far ahead of the other cores that it's really the only choice for Antrius. Though it is worth noting that it doesn't have any health nodes.
...
Note that the damage of the Dexterous core varies depending on the number of 15+ Dexterity champions in the formation. The damage numbers on the layout above account for just 1 (Antrius only). For a specific breakdown of how the core fares with more 15+ Dexterity champions - check the table below.
