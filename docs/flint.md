...
<span id="flint">
![Flint Portrait](images/portraits/flint.png)
</span>

# Flint

<span class="champIntro">Flint is in the Heroes of the Lance affiliation, Neutral Good and normally benefits from the following stat nodes:</span>
...
<span class="champIntro">Flint is a melee champion.</span>
        ...
        <span class="buffboxRow" id="buffboxNone">
            <span class="buffboxRowCol">
                <span class="buffboxRowNone">
                    Flint does not gain the benefit of extra stat nodes from any stat increasing formation abilities.
                </span>
            </span>
        </span>
...
The listed cores are all similar enough in damage for Flint that you should use whichever you have the more favourable pipes for. Though I would not recommend the Magic core as it doesn't have any health nodes.
