...
<span id="raistlin">
![Raistlin Portrait](images/portraits/raistlin.png)
</span>

# Raistlin

<span class="champIntro">Raistlin is in the Heroes of the Lance affiliation, True Neutral and normally benefits from the following stat nodes:</span>
...
<span class="champIntro">Raistlin is a magic champion.</span>
        ...
        <span class="buffboxRow" id="buffboxNone">
            <span class="buffboxRowCol">
                <span class="buffboxRowNone">
                    Raistlin does not gain the benefit of extra stat nodes from any stat increasing formation abilities.
                </span>
            </span>
        </span>
...
{:/nomarkdown}
{::nomarkdown}
    <a href="https://ic.byteglow.com/modron/DsVh4JSKxCnsYuKIstsHI" target="_blank" data-core-id="1" data-buffs="">
{:/nomarkdown}
    <span class="modronRow">
        <span class="modronIconFull">
...
The Dexterous core is far enough ahead of the Magic core that it's the best one to use for Raistlin. I do not recommend even trying the Magic core because it doesn't have any health nodes.
