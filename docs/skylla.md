...
<span id="skylla">
![Skylla Portrait](images/portraits/skylla.png)
</span>

# Skylla

<span class="champIntro">Skylla is unaffiliated, Chaotic Evil and normally benefits from the following stat nodes:</span>
        ...
        <span class="buffboxRow" id="buffboxNone">
            <span class="buffboxRowCol">
                <span class="buffboxRowNone">
                    Skylla does not gain the benefit of extra stat nodes from any stat increasing formation abilities.
                </span>
            </span>
        </span>
...
The Magic core is far enough ahead of the Unaffiliated core that it's the best one to use for Skylla. That said - you could potentially use the Unaffiliated core if the pipes you have favour it. Though it is worth noting that the Magic core doesn't have any health nodes - which could influence your choice.
