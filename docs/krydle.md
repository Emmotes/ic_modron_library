...
<span id="krydle">
![Krydle Portrait](images/portraits/krydle.png)
</span>

# Krydle

<span class="champIntro">Krydle is in the Heroes of Baldur's Gate affiliation and normally benefits from the following stat nodes:</span>
...
<span class="champIntro">Krydle is a melee champion.</span>
        ...
        <span class="buffboxRow" id="buffboxNone">
            <span class="buffboxRowCol">
                <span class="buffboxRowNone">
                    Krydle does not gain the benefit of extra stat nodes from any stat increasing formation abilities.
                </span>
            </span>
        </span>
...
The Dexterous core is so far ahead of the other cores that it's really the only choice for Krydle.

Note that the damage of the Dexterous core varies depending on the number of 15+ Dexterity champions in the formation. The damage numbers on the layout above account for just 1 (Krydle only). For a specific breakdown of how the core fares with more 15+ Dexterity champions - check the table below.
