...
<span class="champIntro">Krux is unaffiliated, Lawful Good and normally benefits from the following stat nodes:</span>
...
The Unaffiliated, Dexterous and Lawful cores are so far ahead of the other cores that they are really the only choices for Krux. Choose whichever you have the more favourable pipes for.
