...
<span id="celeste">
![Celeste Portrait](images/portraits/celeste.png)
</span>

# Celeste

<span class="champIntro">Celeste is unaffiliated, Lawful Good and normally benefits from the following stat nodes:</span>
...
<span class="champIntro">Celeste is a magic champion.</span>
        ...
        <span class="buffboxRow" id="buffboxNone">
            <span class="buffboxRowCol">
                <span class="buffboxRowNone">
                    Celeste does not gain the benefit of extra stat nodes from any stat increasing formation abilities.
                </span>
            </span>
        </span>
...
The Magic, Unaffiliated and Lawful cores are so far ahead of the other cores that they are really the only choices for Celeste. Choose whichever you have the more favourable pipes for - though I would not recommend the Magic core as it doesn't have any health nodes.
