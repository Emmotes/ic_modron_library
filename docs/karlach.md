...
<span id="karlach">
![Karlach Portrait](images/portraits/karlach.png)
</span>

# Karlach

<span class="champIntro">Karlach is in the Absolute Adversaries affiliation and normally benefits from the following stat nodes:</span>
...
<span class="champIntro">Karlach is a melee champion.</span>
        ...
        <span class="buffboxRow" id="buffboxNone">
            <span class="buffboxRowCol">
                <span class="buffboxRowNone">
                    Karlach does not gain the benefit of extra stat nodes from any stat increasing formation abilities.
                </span>
            </span>
        </span>
...
The Strong core is far enough ahead of the Modest core that it's the best one to use for Karlach. That said - you could potentially use the Modest core if the pipes you have favour it.
...
Note that the damage of the Dexterous core varies depending on the number of 15+ Dexterity champions in the formation. The damage numbers on the layout above account for just 1 (Karlach only). For a specific breakdown of how the core fares with more 15+ Dexterity champions - check the table below.
