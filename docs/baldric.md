...
<span class="champIntro">Baldric is in the The Fallbacks affiliation, Lawful Neutral and normally benefits from the following stat nodes:</span>
...
The Lawful core is far enough ahead of the Magic (Non-Magic Variant) core that it's the best one to use for Baldric. I do not recommend even trying the Magic core because it doesn't have any health nodes.
