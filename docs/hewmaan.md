...
<span class="champIntro">Hew Maan is unaffiliated, Lawful Evil and normally benefits from the following stat nodes:</span>
...
The Unaffiliated and Lawful cores are so far ahead of the Magic (Non-Magic Variant) core that they are really the only choices for Hew Maan. Choose whichever you have the more favourable pipes for.
