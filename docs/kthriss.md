...
<span id="kthriss">
![K'thriss Portrait](images/portraits/kthriss.png)
</span>

# K'thriss

<span class="champIntro">K'thriss is in the Acq Inc "C" Team affiliation, Chaotic Neutral and normally benefits from the following stat nodes:</span>
...
<span class="champIntro">K'thriss is a magic champion.</span>
        ...
        <span class="buffboxRow" id="buffboxNone">
            <span class="buffboxRowCol">
                <span class="buffboxRowNone">
                    K'thriss does not gain the benefit of extra stat nodes from any stat increasing formation abilities.
                </span>
            </span>
        </span>
