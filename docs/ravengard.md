...
<span class="champIntro">Ravengard is supposed to be unaffiliated (but lacks the tag for it and so technically isn't) and normally benefits from the following stat nodes:</span>
...
The listed cores are all similar enough in damage for Ravengard that you should use whichever you have the more favourable pipes for. Though I would not recommend the Magic core as it doesn't have any health nodes.
...
Note that the damage of the Dexterous core varies depending on the number of 15+ Dexterity champions in the formation. The damage numbers on the layout above account for just 1 (Ravengard only). For a specific breakdown of how the core fares with more 15+ Dexterity champions - check the table below.
