...
<span class="champIntro">Birdsong is unaffiliated, Lawful Neutral and normally benefits from the following stat nodes:</span>
...
<span class="champIntro">Birdsong is a melee champion.</span>
        ...
        <span class="buffboxRow" id="buffboxNone">
            <span class="buffboxRowCol">
                <span class="buffboxRowNone">
                    Birdsong does not gain the benefit of extra stat nodes from any stat increasing formation abilities.
                </span>
            </span>
        </span>
...
The Unaffiliated, Dexterous and Lawful cores are so far ahead of the other cores that they are really the only choices for Birdsong. Choose whichever you have the more favourable pipes for.
