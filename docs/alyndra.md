...
<span id="alyndra">
![Alyndra Portrait](images/portraits/alyndra.png)
</span>

# Alyndra

<span class="champIntro">Alyndra is in the Heroes of the Planes affiliation and normally benefits from the following stat nodes:</span>
...
<span class="champIntro">Alyndra is a magic champion.</span>
        ...
        <span class="buffboxRow" id="buffboxNone">
            <span class="buffboxRowCol">
                <span class="buffboxRowNone">
                    Alyndra does not gain the benefit of extra stat nodes from any stat increasing formation abilities.
                </span>
            </span>
        </span>
...
{::nomarkdown}
    <a href="https://ic.byteglow.com/modron/tOjND8g1reUg7l_i9NYYF" target="_blank" data-core-id="4" data-buffs="Smooth Negotiators" hidden>
{:/nomarkdown}
...
{:/nomarkdown}
{::nomarkdown}
    <a href="https://ic.byteglow.com/modron/Ji-4uNBtTC7mLA3UCQyfB" target="_blank" data-core-id="1" data-buffs="">
{:/nomarkdown}
    <span class="modronRow">
        <span class="modronIconFull">
            ![Modest Core](images/core_1_modest.png)Modest
...
The Magic core is so far ahead of the other cores that it's really the only choice for Alyndra. Though it is worth noting that it doesn't have any health nodes.
...
Note that the damage of the Dexterous core varies depending on the number of 15+ Dexterity champions in the formation. The damage numbers on the layout above account for just 1 (Alyndra only). For a specific breakdown of how the core fares with more 15+ Dexterity champions - check the table below.
