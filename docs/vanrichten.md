...
<span id="vanrichten">
![Van Richten Portrait](images/portraits/vanrichten.png)
</span>

# Van Richten

<span class="champIntro">Van Richten is unaffiliated, Lawful Good and normally benefits from the following stat nodes:</span>
...
<span class="champIntro">Van Richten is a melee champion.</span>
        ...
        <span class="buffboxRow" id="buffboxNone">
            <span class="buffboxRowCol">
                <span class="buffboxRowNone">
                    Van Richten does not gain the benefit of extra stat nodes from any stat increasing formation abilities.
                </span>
            </span>
        </span>
...
{:/nomarkdown}
{::nomarkdown}
    <a href="https://ic.byteglow.com/modron/NiGSGsacHW4McSTThGhaB" target="_blank" data-core-id="2" data-buffs="Witch's Switch" hidden>
{:/nomarkdown}
    <span class="modronRow">
        <span class="modronIconFull">
...
The Unaffiliated and Lawful cores are far enough ahead of the Magic (Non-Magic Variant) core that they are the best ones to use for Van Richten. I do not recommend even trying the Magic core because it doesn't have any health nodes.
