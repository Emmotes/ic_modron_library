...
<span class="champIntro">Thellora is unaffiliated, Lawful Neutral and normally benefits from the following stat nodes:</span>
...
The Unaffiliated and Lawful cores are so far ahead of the other cores that they are really the only choices for Thellora. Choose whichever you have the more favourable pipes for.
