...
<span class="champIntro">Nordom is unaffiliated, Lawful Neutral and normally benefits from the following stat nodes:</span>
...
The Unaffiliated, Dexterous and Lawful cores are so far ahead of the other cores that they are really the only choices for Nordom. Choose whichever you have the more favourable pipes for.
