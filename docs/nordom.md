...
<span id="nordom">
![Nordom Portrait](images/portraits/nordom.png)
</span>

# Nordom

<span class="champIntro">Nordom is unaffiliated and normally benefits from the following stat nodes:</span>
...
<span class="champIntro">Nordom is a ranged champion.</span>
        ...
        <span class="buffboxRow" id="buffboxNone">
            <span class="buffboxRowCol">
                <span class="buffboxRowNone">
                    Nordom does not gain the benefit of extra stat nodes from any stat increasing formation abilities.
                </span>
            </span>
        </span>
...
{:/nomarkdown}
    <span class="modronRow">
        ...
        <span class="modronLink">
            https://ic.byteglow.com/modron/sGv2PkfUhcXsZAEQEDdvy
        </span>
        <span class="modronDamage">
            3.33e40%
        </span>
...
{:/nomarkdown}
    <span class="modronRow">
        ...
        <span class="modronLink">
            https://ic.byteglow.com/modron/80K7ITgZH227LMZ8Z-Xr2
        </span>
        <span class="modronDamage">
            1.04e37%
        </span>
...
The Unaffiliated and Dexterous cores are so far ahead of the other cores that they are really the only choices for Nordom. Choose whichever you have the more favourable pipes for.

Note that the damage of the Unaffiliated and Dexterous cores vary depending on the number of unaffiliated or 15+ Dexterity champions (respectively) in the formation. The damage numbers on the layout above account for just 1 (Nordom only). For a specific breakdown of how the cores fare with more unaffiliated or 15+ Dexterity champions - check the tables below.
