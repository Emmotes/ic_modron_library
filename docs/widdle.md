...
<span id="widdle">
![Widdle Portrait](images/portraits/widdle.png)
</span>

# Widdle

<span class="champIntro">Widdle is in the Heroes of the Planes affiliation and normally benefits from the following stat nodes:</span>
...
<span class="champIntro">Widdle is a magic champion.</span>
        ...
        <span class="buffboxRow" id="buffboxNone">
            <span class="buffboxRowCol">
                <span class="buffboxRowNone">
                    Widdle does not gain the benefit of extra stat nodes from any stat increasing formation abilities.
                </span>
            </span>
        </span>
