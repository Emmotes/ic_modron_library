...
{:/nomarkdown}
{::nomarkdown}
    <a href="https://ic.byteglow.com/modron/v9_gE6eMlDAK1AUhuOvHB" target="_blank">
{:/nomarkdown}
    <span class="modronRow">
        <span class="modronIcon">
            ![Aerois Core](images/core_5_aerois.png)Aerois
        ...
        <span class="modronLink">
            ic.byteglow.com/modron/v9_gE6eMlDAK1AUhuOvHB
        </span>
        <span class="modronRecord">
            2
        </span>
...
{:/nomarkdown}
{::nomarkdown}
    <a href="https://ic.byteglow.com/modron/GtIR6tkSNjy3R6XEClYvL" target="_blank">
{:/nomarkdown}
    <span class="modronRow">
        <span class="modronIcon">
            ![Unaffiliated Core](images/core_6_unaffiliated.png)Unaffiliated
        ...
        <span class="modronLink">
            ic.byteglow.com/modron/GtIR6tkSNjy3R6XEClYvL
        </span>
        <span class="modronRecord">
            0
        </span>
