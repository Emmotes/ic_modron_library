...
These are community-led designs where the goal is to improve on those who came before. If you can do better than a design found here - create a byteglow link and either put it in the modron channel in the Discord and ping me - or DM me (emmote) and I'll make sure you're put on the boards.
...
{:/nomarkdown}
{::nomarkdown}
    <a href="https://ic.byteglow.com/modron/BAt7OV1uE-wNGs8o8V79p" target="_blank">
{:/nomarkdown}
    <span class="modronRow">
        <span class="modronIcon">
            ![Strong Core](images/core_2_strong.png)Strong
        ...
        <span class="modronLink">
            ic.byteglow.com/modron/BAt7OV1uE-wNGs8o8V79p
        </span>
        <span class="modronRecord">
            2
        </span>
...
{:/nomarkdown}
{::nomarkdown}
    <a href="https://ic.byteglow.com/modron/zUnREhDU7__PYvFlDad_B" target="_blank">
{:/nomarkdown}
    <span class="modronRow">
        <span class="modronIcon">
            ![Aerois Core](images/core_5_aerois.png)Aerois
        ...
        <span class="modronLink">
            ic.byteglow.com/modron/zUnREhDU7__PYvFlDad_B
        </span>
        <span class="modronRecord">
            2
        </span>
...
{:/nomarkdown}
{::nomarkdown}
    <a href="https://ic.byteglow.com/modron/9CuXJtG5acewlOgKu_R-b" target="_blank">
{:/nomarkdown}
    <span class="modronRow">
        <span class="modronIcon">
            ![Unaffiliated Core](images/core_6_unaffiliated.png)Unaffiliated
        ...
        <span class="modronLink">
            ic.byteglow.com/modron/9CuXJtG5acewlOgKu_R-b
        </span>
        <span class="modronRecord">
            0
        </span>
