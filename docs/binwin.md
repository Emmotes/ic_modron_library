...
<span class="champIntro">Binwin is unaffiliated, Lawful Good and normally benefits from the following stat nodes:</span>
...
The Unaffiliated and Lawful cores are so far ahead of the other cores that they are really the only choices for Binwin. Choose whichever you have the more favourable pipes for.
