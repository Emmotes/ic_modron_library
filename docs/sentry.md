...
<span id="sentry">
![Sentry Portrait](images/portraits/sentry.png)
</span>

# Sentry

<span class="champIntro">Sentry is in the Heroes of Aerois affiliation and normally benefits from the following stat nodes:</span>
...
<span class="champIntro">Sentry is a melee champion.</span>
...
The listed cores are all similar enough in damage for Sentry that you should use whichever you have the more favourable pipes for. Though I would not recommend the Magic core as it doesn't have any health nodes.
...
Note that the damage of the Dexterous core varies depending on the number of 15+ Dexterity champions in the formation. The damage numbers on the layout above account for just 1 (Sentry only). For a specific breakdown of how the core fares with more 15+ Dexterity champions - check the table below.
