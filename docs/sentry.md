...
<span class="champIntro">Sentry is in the Heroes of Aerois affiliation, Lawful Good and normally benefits from the following stat nodes:</span>
...
The Lawful core is so far ahead of the other cores that it's really the only choice for Sentry.
