...
<span id="evandra">
![Evandra Portrait](images/portraits/evandra.png)
</span>

# Evandra

<span class="champIntro">Evandra is in the Awful Ones affiliation and normally benefits from the following stat nodes:</span>
...
<span class="champIntro">Evandra is a melee champion.</span>
        ...
        <span class="buffboxRow" id="buffboxNone">
            <span class="buffboxRowCol">
                <span class="buffboxRowNone">
                    Evandra does not gain the benefit of extra stat nodes from any stat increasing formation abilities.
                </span>
            </span>
        </span>
...
The listed cores are all similar enough in damage for Evandra that you should use whichever you have the more favourable pipes for. Though I would not recommend the Magic core as it doesn't have any health nodes.
...
Note that the damage of the Dexterous core varies depending on the number of 15+ Dexterity champions in the formation. The damage numbers on the layout above account for just 1 (Evandra only). For a specific breakdown of how the core fares with more 15+ Dexterity champions - check the table below.
