...
<span id="freely">
![Freely Portrait](images/portraits/freely.png)
</span>

# Freely

<span class="champIntro">Freely is in the Heroes of the Planes affiliation and normally benefits from the following stat nodes:</span>
...
<span class="champIntro">Freely is a magic champion.</span>
        ...
        <span class="buffboxRow" id="buffboxNone">
            <span class="buffboxRowCol">
                <span class="buffboxRowNone">
                    Freely does not gain the benefit of extra stat nodes from any stat increasing formation abilities.
                </span>
            </span>
        </span>
...
{::nomarkdown}
    <a href="https://ic.byteglow.com/modron/tOjND8g1reUg7l_i9NYYF" target="_blank" data-core-id="4" data-buffs="Feats to Spare,Circle Magic,Witch's Switch" hidden>
{:/nomarkdown}
...
{:/nomarkdown}
{::nomarkdown}
    <a href="https://ic.byteglow.com/modron/yCOf6JkDOJA07gVqpOm5t" target="_blank" data-core-id="4" data-buffs="Witch's Switch" hidden>
{:/nomarkdown}
    <span class="modronRow">
        <span class="modronIconFull">
            ![Magic Core](images/core_4_magic.png)Magic
...
{:/nomarkdown}
{::nomarkdown}
    <a href="https://ic.byteglow.com/modron/dqiI3WxKx8gYnqFFrmddG" target="_blank" data-core-id="1" data-buffs="Feats to Spare,Circle Magic,Witch's Switch,Samurai Training" hidden>
{:/nomarkdown}
    <span class="modronRow">
        <span class="modronIconFull">
...
{:/nomarkdown}
{::nomarkdown}
    <a href="https://ic.byteglow.com/modron/H8TK3pxjZneEx4U0KKJP3" target="_blank" data-core-id="2" data-buffs="Feats to Spare,Circle Magic,Witch's Switch,Samurai Training" hidden>
{:/nomarkdown}
    <span class="modronRow">
        <span class="modronIconFull">
...
{:/nomarkdown}
{::nomarkdown}
    <a href="https://ic.byteglow.com/modron/bp9VallQeBOfWzBipLNGM" target="_blank" data-core-id="1" data-buffs="Witch's Switch,Samurai Training" hidden>
{:/nomarkdown}
    <span class="modronRow">
        <span class="modronIconFull">
            ![Modest Core](images/core_1_modest.png)Modest
        ...
        <span class="modronLink">
            ic.byteglow.com/modron/bp9VallQeBOfWzBipLNGM
        </span>
        <span class="modronDamageBuffed">
            4.16e40%
        </span>
...
{:/nomarkdown}
{::nomarkdown}
    <a href="https://ic.byteglow.com/modron/hSkuYG38hob-SwKeX8PvK" target="_blank" data-core-id="1" data-buffs="Feats to Spare,Circle Magic,Witch's Switch" hidden>
{:/nomarkdown}
    <span class="modronRow">
        <span class="modronIconFull">
            ![Modest Core](images/core_1_modest.png)Modest
...
{:/nomarkdown}
{::nomarkdown}
    <a href="https://ic.byteglow.com/modron/7J_aSDIQtryetxDSnl3Uu" target="_blank" data-core-id="2" data-buffs="Feats to Spare,Circle Magic,Witch's Switch" hidden>
{:/nomarkdown}
    <span class="modronRow">
        <span class="modronIconFull">
            ![Strong Core](images/core_2_strong.png)Strong (Non-Melee Variant)
        ...
        <span class="modronLink">
            ic.byteglow.com/modron/7J_aSDIQtryetxDSnl3Uu
        </span>
        <span class="modronDamageBuffed">
            1.37e39%
        </span>
...
{:/nomarkdown}
{::nomarkdown}
    <a href="https://ic.byteglow.com/modron/F5AhmatzGB4RqEdgZuos2" target="_blank" data-core-id="2" data-buffs="Witch's Switch,Samurai Training" hidden>
{:/nomarkdown}
    <span class="modronRow">
        <span class="modronIconFull">
            ![Strong Core](images/core_2_strong.png)Strong (Non-Melee Variant)
...
{:/nomarkdown}
{::nomarkdown}
    <a href="https://ic.byteglow.com/modron/dcS-lL648rYWPnxbdpuQA" target="_blank" data-core-id="1" data-buffs="Witch's Switch" hidden>
{:/nomarkdown}
    <span class="modronRow">
        <span class="modronIconFull">
            ![Modest Core](images/core_1_modest.png)Modest
        ...
        <span class="modronLink">
            ic.byteglow.com/modron/dcS-lL648rYWPnxbdpuQA
        </span>
        <span class="modronDamageBuffed">
            2.87e38%
        </span>
...
{:/nomarkdown}
{::nomarkdown}
    <a href="https://ic.byteglow.com/modron/WMcFvw1hORCPn3x4CqB1o" target="_blank" data-core-id="2" data-buffs="Witch's Switch" hidden>
{:/nomarkdown}
    <span class="modronRow">
        <span class="modronIconFull">
            ![Strong Core](images/core_2_strong.png)Strong (Non-Melee Variant)
        ...
        <span class="modronLink">
            ic.byteglow.com/modron/WMcFvw1hORCPn3x4CqB1o
        </span>
        <span class="modronDamageBuffed">
            9.45e36%
        </span>
...
{:/nomarkdown}
{::nomarkdown}
    <a href="https://ic.byteglow.com/modron/e5l-Cqc9D-lsTtSy8j0qv" target="_blank" data-core-id="2" data-buffs="">
{:/nomarkdown}
    <span class="modronRow">
        <span class="modronIconFull">
            ![Strong Core](images/core_2_strong.png)Strong (Non-Melee Variant)
...
Note that the damage of the Dexterous core varies depending on the number of 15+ Dexterity champions in the formation. The damage numbers on the layout above account for just 1 (Freely only). For a specific breakdown of how the core fares with more 15+ Dexterity champions - check the table below.
