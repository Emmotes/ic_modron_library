...
<span class="champIntro">Freely is in the Heroes of the Planes affiliation, Neutral Good and normally benefits from the following stat nodes:</span>
...
{::nomarkdown}
    <a href="https://ic.byteglow.com/modron/JT8G1GuvxO8RztguPGG6A" target="_blank" data-core-id="4" data-buffs="Feats to Spare,Circle Magic,Witch's Switch" hidden>
{:/nomarkdown}
...
{:/nomarkdown}
{::nomarkdown}
    <a href="https://ic.byteglow.com/modron/rHBEye_cAQYKX2pdhIxaH" target="_blank" data-core-id="4" data-buffs="Witch's Switch" hidden>
{:/nomarkdown}
    <span class="modronRow">
        <span class="modronIconFull">
            ![Magic Core](images/core_4_magic.png)Magic
