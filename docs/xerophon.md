...
<span id="xerophon">
![Xerophon Portrait](images/portraits/xerophon.png)
</span>

# Xerophon

<span class="champIntro">Xerophon is unaffiliated, True Neutral and normally benefits from the following stat nodes:</span>
...
<span class="champIntro">Xerophon is a melee champion.</span>
        ...
        <span class="buffboxRow" id="buffboxNone">
            <span class="buffboxRowCol">
                <span class="buffboxRowNone">
                    Xerophon does not gain the benefit of extra stat nodes from any stat increasing formation abilities.
                </span>
            </span>
        </span>
