...
<span class="champIntro">Aeon is supposed to be unaffiliated (but lacks the tag for it and so technically isn't) and normally benefits from the following stat nodes:</span>
...
{:/nomarkdown}
{::nomarkdown}
    <a href="https://ic.byteglow.com/modron/uaxwwiADbr1-LgADkbgay" target="_blank" data-core-id="1" data-buffs="Samurai Training" hidden>
{:/nomarkdown}
    <span class="modronRow">
        <span class="modronIconFull">
            ![Modest Core](images/core_1_modest.png)Modest
...
The Magic (Non-Magic Variant) core is so far ahead of the other cores that it's really the only choice for Aeon. Though it is worth noting that it doesn't have any health nodes.
...
Note that the damage of the Dexterous core varies depending on the number of 15+ Dexterity champions in the formation. The damage numbers on the layout above account for just 1 (Aeon only). For a specific breakdown of how the core fares with more 15+ Dexterity champions - check the table below.
