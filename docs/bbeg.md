...
<span class="champIntro">BBEG is unaffiliated, Lawful Evil and normally benefits from the following stat nodes:</span>
...
The Magic core is far enough ahead of the other cores that it's the best one to use for BBEG. That said - you could potentially use the Unaffiliated or Lawful core if the pipes you have favours one of them. Though it is worth noting that the Magic core doesn't have any health nodes - which could influence your choice.
