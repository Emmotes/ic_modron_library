...
<span id="gale">
![Gale Portrait](images/portraits/gale.png)
</span>

# Gale

<span class="champIntro">Gale is in the Absolute Adversaries affiliation and normally benefits from the following stat nodes:</span>
...
<span class="champIntro">Gale is a magic champion.</span>
        ...
        <span class="buffboxRow" id="buffboxNone">
            <span class="buffboxRowCol">
                <span class="buffboxRowNone">
                    Gale does not gain the benefit of extra stat nodes from any stat increasing formation abilities.
                </span>
            </span>
        </span>
...
{:/nomarkdown}
{::nomarkdown}
    <a href="https://ic.byteglow.com/modron/uPENWunG92vAP47zSu7uZ" target="_blank" data-core-id="1" data-buffs="Smooth Negotiators" hidden>
{:/nomarkdown}
    <span class="modronRow">
        <span class="modronIconFull">
...
{:/nomarkdown}
{::nomarkdown}
    <a href="https://ic.byteglow.com/modron/U8o2y_ATayNDoUuHJPc3q" target="_blank" data-core-id="1" data-buffs="">
{:/nomarkdown}
    <span class="modronRow">
        <span class="modronIconFull">
            ![Modest Core](images/core_1_modest.png)Modest
...
{:/nomarkdown}
{::nomarkdown}
    <a href="https://ic.byteglow.com/modron/S_qeCn1ZXX_fnZxXXPvzC" target="_blank" data-core-id="1" data-buffs="Witch's Switch" hidden>
{:/nomarkdown}
    <span class="modronRow">
        <span class="modronIconFull">
            ![Modest Core](images/core_1_modest.png)Modest
...
The Magic core is so far ahead of the other cores that it's really the only choice for Gale. Though it is worth noting that it doesn't have any health nodes.
...
Note that the damage of the Dexterous core varies depending on the number of 15+ Dexterity champions in the formation. The damage numbers on the layout above account for just 1 (Gale only). For a specific breakdown of how the core fares with more 15+ Dexterity champions - check the table below.
