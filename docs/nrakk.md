...
<span class="champIntro">Nrakk is unaffiliated, Lawful Neutral and normally benefits from the following stat nodes:</span>
...
The Unaffiliated, Dexterous and Lawful cores are far enough ahead of the other cores that they are the best ones to use for Nrakk. That said - you could potentially use one of the other cores if the pipes you have favours one of them.
